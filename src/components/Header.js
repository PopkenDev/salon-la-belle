...
export default function Header() {
  return (
    <header className="max-w-6xl mx-auto px-4 flex justify-between items-center py-3">
      <div>
        <img className="md:w-64 w-36" src={logo} alt="logo" />
      </div>
      <div className="flex flex-col gap-y-2">
        <div className="flex items-center justify-end gap-x-2">
          <a className="bg-primary p-1 text-gray-100 hidden md:inline-block" href="#!">
        ...
        <a href="#!" className="flex items-center gap-x-1 bg-secondary text-gray-100 md:text-sm text-xs px-4 py-2">
          <span>
